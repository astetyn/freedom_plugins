...
public class GPlayer {
	...
	private final List<String> ignoredPlayersNames;
	private boolean alreadyJoinedFromAuth;
	...
	public boolean isAlreadyJoinedFromAuth() {
		return alreadyJoinedFromAuth;
	}

	public void setAlreadyJoinedFromAuth(boolean alreadyJoinedFromAuth) {
		this.alreadyJoinedFromAuth = alreadyJoinedFromAuth;
	}
}
