...
public class ChatUtils {
	...
	public static final String PLUGIN_PREFIX = ChatColor.WHITE+"["+ChatColor.GREEN+"Chat"+ChatColor.WHITE+"] "+ChatColor.RESET;
	...
	public static final BaseComponent[] SILENCE_CANT_TALK = TextComponent.fromLegacyText(ChatUtils.SILENCE + ChatColor.GRAY + "You are silenced. Your messages are not visible.");
