...
public class MuteAllCommand extends Command {
	...
	public void execute(CommandSender commandSender, String[] args) {
		...
		for(GPlayer pdd : Main.gPlayers) {
			...
			pdd.getProxiedPlayer().sendMessage(TextComponent.fromLegacyText(ChatUtils.SILENCE + "All players have been silenced. Your messages will not be shown."));
		}
		pp.sendMessage(TextComponent.fromLegacyText(ChatUtils.SILENCE + "All players except you have been silenced."));
