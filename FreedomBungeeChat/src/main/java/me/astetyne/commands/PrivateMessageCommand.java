...
public class PrivateMessageCommand extends Command {
	...
	public void execute(CommandSender commandSender, String[] args) {
		...
		if(pd.isMuted()) {
			pp.sendMessage(ChatUtils.SILENCE_CANT_TALK);
			return;
		}
		...
		if(tokenCount<2) {
			pp.sendMessage(TextComponent.fromLegacyText(ChatUtils.PRIVATE_MESSAGE + ChatColor.RED + "/msg <receiver> <me.astetyne.message>"));
