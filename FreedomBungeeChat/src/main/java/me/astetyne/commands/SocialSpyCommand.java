...
public class SocialSpyCommand extends Command {
	...
	public void execute(CommandSender commandSender, String[] args) {
		...
		if(pd.hasSocialSpy()) {
			pp.sendMessage(TextComponent.fromLegacyText(ChatUtils.SOCIAL_SPY + ChatColor.RED + "deactivated."));
			pd.setSocialSpy(false);
		}else {
			pp.sendMessage(TextComponent.fromLegacyText(ChatUtils.SOCIAL_SPY + ChatColor.GREEN + "activated."));
